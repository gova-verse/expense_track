...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 9. Settings >> 9c. Notifications settings page loads
- Location: tests\auth.spec.ts:282:9
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    30 × locator resolved to <html lang="en" class="light">…</html>
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443619440@example.com
- group:
  - text: Password
