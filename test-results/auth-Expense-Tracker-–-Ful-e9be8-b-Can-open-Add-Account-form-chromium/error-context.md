...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 4. Accounts >> 4b. Can open Add Account form
- Location: tests\auth.spec.ts:186:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443477245@example.com
- group:
  - text: Password
