...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 5. Transactions >> 5a. Transactions page loads
- Location: tests\auth.spec.ts:205:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443495081@example.com
- group:
  - text: Password
