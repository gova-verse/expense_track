...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 6. Categories >> 6a. Expense categories page loads
- Location: tests\auth.spec.ts:218:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443512842@example.com
- group:
  - text: Password
