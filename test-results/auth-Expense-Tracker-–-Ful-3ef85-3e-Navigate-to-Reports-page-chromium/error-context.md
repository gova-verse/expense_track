...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 3. Navigation >> 3e. Navigate to Reports page
- Location: tests\auth.spec.ts:166:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443441131@example.com
- group:
  - text: Password
