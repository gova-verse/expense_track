...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 9. Settings >> 9a. Appearance settings page loads
- Location: tests\auth.spec.ts:270:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443584099@example.com
- group:
  - text: Password
