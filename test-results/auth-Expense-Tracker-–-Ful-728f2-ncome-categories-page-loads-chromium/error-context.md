...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 6. Categories >> 6b. Income categories page loads
- Location: tests\auth.spec.ts:225:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443530392@example.com
- group:
  - text: Password
