...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 9. Settings >> 9d. Privacy settings page loads
- Location: tests\auth.spec.ts:288:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443637525@example.com
- group:
  - text: Password
