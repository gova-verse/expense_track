...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 3. Navigation >> 3d. Navigate to Budgets page
- Location: tests\auth.spec.ts:161:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443422587@example.com
- group:
  - text: Password
