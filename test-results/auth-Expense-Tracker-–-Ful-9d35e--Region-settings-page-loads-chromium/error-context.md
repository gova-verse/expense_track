...
- Name: auth.spec.ts >> Expense Tracker – Full Flow >> 9. Settings >> 9b. Currency & Region settings page loads
- Location: tests\auth.spec.ts:276:9
...
- group:
  ...
  - textbox "Email":
    ...
    - text: pw_test_1789443601962@example.com
- group:
  - text: Password
